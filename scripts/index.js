...
document.querySelector("#signDimage").addEventListener("click", function(){
    location.href = 'DSize.html';
})

document.querySelector("#signBimage").addEventListener("click", function(){
    location.href = 'BSize.html';
})

document.querySelector("#signCimage").addEventListener("click", function(){
